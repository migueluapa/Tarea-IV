...
namespace Empleados
{
    public partial class Detalle_Nomina : Form
    {
        ...
        public SQLiteConnection conexion = new SQLiteConnection("Data Source=C:/sistema/Visual C #-SQLite/Empleados_BD_SQLite.s3db");
        ...
        public void autogenerar()
        {
          ...
          //  SQLiteConnection conexion = new SQLiteConnection("Data Source=C:/Users/juan/Desktop/Visual C #-SQLite/Empleados_BD_SQLite.s3db");
        ...
        private void cargardato_detalle_nomina()
        {
            ...
            conexion = new SQLiteConnection("Data Source=C:/sistema/Visual C #-SQLite/Empleados_BD_SQLite.s3db");
